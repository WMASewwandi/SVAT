...
const CreateSVATInvoice = () => {
  ...
  const setRefWithAutoNumber = () => {
    const autoGeneratedNum = Math.floor(100000 + Math.random() * 900000);
    autoNumRef.current = autoGeneratedNum;
    setRefNo(autoNumRef.current);
  };
